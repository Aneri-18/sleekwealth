      ...
      <div className="mx-auto max-w-[860px]">
        ...
        <div className="mb-6">
          ...
          <div className="mt-2.5 grid grid-cols-1 gap-2.5 md:grid-cols-2">
            <label className="block">
              <span className="mb-1 block font-satoshi text-[11px] text-parchment/60">Alt text</span>
              <input
                value={featuredImageAlt}
                onChange={(e) => setFeaturedImageAlt(e.target.value)}
                placeholder="Describe the image plainly"
                className="w-full rounded-md border border-cognac/30 bg-transparent px-3 py-2 font-satoshi text-xs text-parchment outline-none placeholder:text-parchment/30 focus:border-cognac"
              />
            </label>
            <label className="block">
              <span className="mb-1 block font-satoshi text-[11px] text-parchment/60">Caption (optional)</span>
              <input
                value={featuredImageCaption}
                onChange={(e) => setFeaturedImageCaption(e.target.value)}
                placeholder="Shown centered beneath the hero image"
                className="w-full rounded-md border border-cognac/30 bg-transparent px-3 py-2 font-satoshi text-xs text-parchment outline-none placeholder:text-parchment/30 focus:border-cognac"
              />
            </label>
          </div>
...
function ToolbarButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`flex h-8 w-8 items-center justify-center rounded-md font-satoshi text-[13px] transition-colors disabled:opacity-30 disabled:hover:bg-transparent ${
