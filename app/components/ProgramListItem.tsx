...
export default function ProgramListItem({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 basis-[280px] items-center justify-start gap-5 md:min-w-0">
        <span
          className="inline-block origin-left whitespace-normal font-vollkorn text-base leading-[1.5] text-parchment opacity-85 transition-transform duration-[400ms] ease-sw group-hover:scale-[1.03]"
        >
          {description}
        </span>
